  ...
  public: {
    Tables: {
      ...
      cliente_audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "cliente_audit_log_cliente_cpf_fkey"
            columns: ["cliente_cpf"]
            isOneToOne: false
      ...
      cliente_interacoes: {
        ...
        Relationships: [
          {
            foreignKeyName: "cliente_interacoes_cliente_cpf_fkey"
            columns: ["cliente_cpf"]
            isOneToOne: false
            referencedRelation: "clientes"
            referencedColumns: ["cpf"]
      ...
      clientes: {
        Row: {
          ...
          cliente: string
          consorcio_imovel: boolean | null
          consorcio_imovel_credito: number | null
          consorcio_outros: boolean | null
          consorcio_outros_credito: number | null
          consorcio_veiculo: boolean | null
          consorcio_veiculo_credito: number | null
          contato_feito: boolean | null
          cpf: string
          created_at: string | null
          ...
          exported_to_crm: boolean | null
          hedge_agro_tipo: string | null
          hedge_agro_valor_anual: number | null
          hedge_assessoria: boolean | null
          hedge_assessoria_valor: number | null
          hedge_consultoria: boolean | null
          hedge_consultoria_valor: number | null
          investimentos_internacionais: boolean | null
          investimentos_internacionais_valor_usd: number | null
          investimentos_nacionais: boolean | null
          investimentos_nacionais_valor: number | null
          notas_adicionais: string | null
          pipedrive_deal_id: number | null
          pipedrive_person_id: number | null
          planejamento_financeiro: boolean | null
          planejamento_financeiro_valor_anual: number | null
          ponto_venda: string | null
          previdencia: boolean | null
          previdencia_valor: number | null
          produto_vendido: string | null
          produtos_inbanq: boolean | null
          produtos_inbanq_valor: number | null
          profissao: string | null
          responsavel: string | null
          seguro_vida_internacional: boolean | null
          seguro_vida_internacional_valor: number | null
          seguro_vida_nacional: boolean | null
          seguro_vida_nacional_valor: number | null
          telefone: string | null
          ultima_atualizacao_status: string | null
          updated_at: string | null
          valor_venda: number | null
          venda_data: string | null
          venda_gerada: boolean | null
        }
        Insert: {
          bu?: string | null
          cidade?: string | null
      ...
      codigo_xp_mapping: {
        Row: {
          ...
          nome_assessor_xp: string
          nome_responsavel_sistema: string
        }
        Insert: {
          codigo_xp: string
          created_at?: string | null
      ...
      detailed_meeting_analyses: {
        Row: {
          analysis_text: string
          created_at: string | null
          email_template: string | null
          four_pots_summary: string | null
          id: string
          meeting_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "detailed_meeting_analyses_meeting_id_fkey"
            columns: ["meeting_id"]
            isOneToOne: false
            referencedRelation: "teams_meetings"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      meeting_analytics: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["meeting_id"]
            isOneToOne: false
            referencedRelation: "teams_dashboard_view"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      opportunity_list_matches: {
        ...
        Relationships: [
          {
            foreignKeyName: "opportunity_list_matches_cliente_cpf_fkey"
            columns: ["cliente_cpf"]
            isOneToOne: false
            referencedRelation: "clientes"
            referencedColumns: ["cpf"]
          ...
          {
            foreignKeyName: "opportunity_list_matches_list_id_fkey"
            columns: ["list_id"]
            isOneToOne: false
            referencedRelation: "opportunity_lists"
            referencedColumns: ["id"]
          },
        ]
      }
      opportunity_list_visibility: {
        Row: {
          created_at: string | null
          id: string
          list_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "opportunity_list_visibility_list_id_fkey"
            columns: ["list_id"]
            isOneToOne: false
            referencedRelation: "opportunity_lists"
            referencedColumns: ["id"]
      ...
      pipedrive_meeting_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "pipedrive_meeting_links_meeting_id_fkey"
            columns: ["meeting_id"]
            isOneToOne: false
            referencedRelation: "teams_meetings"
            referencedColumns: ["id"]
      ...
      playbook_analysis_results: {
        Row: {
          action_plan: Json | null
          best_practices_followed: Json | null
        ...
        Relationships: [
          {
            foreignKeyName: "playbook_analysis_results_meeting_id_fkey"
            columns: ["meeting_id"]
            isOneToOne: false
            referencedRelation: "teams_meetings"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "playbook_analysis_results_playbook_id_fkey"
            columns: ["playbook_id"]
            isOneToOne: false
      ...
      responsavel_mapping: {
        Row: {
          ...
          pipedrive_user_id: number | null
          produtos_disponiveis: string[] | null
      ...
      responsavel_merge_history: {
        Row: {
          ...
          nome_final: string
          nomes_mesclados: string[]
          user_id_vinculado: string | null
        }
        Insert: {
          clientes_afetados: number
          created_at?: string | null
      ...
      teams_business_unit_playbooks: {
        ...
        Relationships: [
          {
            foreignKeyName: "teams_business_unit_playbooks_business_unit_id_fkey"
          ...
          {
            foreignKeyName: "teams_business_unit_playbooks_playbook_id_fkey"
            columns: ["playbook_id"]
            isOneToOne: false
            referencedRelation: "teams_playbooks"
            referencedColumns: ["id"]
          },
        ]
      }
      teams_business_units: {
        Row: {
          color: string | null
          created_at: string | null
          description: string | null
      ...
      teams_insights: {
        ...
        Relationships: [
          {
            foreignKeyName: "teams_insights_meeting_id_fkey"
            columns: ["meeting_id"]
            isOneToOne: false
            referencedRelation: "teams_meetings"
            referencedColumns: ["id"]
      ...
      teams_meeting_insights: {
        Row: {
          ...
          meeting_type_edited_by_user: boolean | null
          overall_priority_level: string | null
          overall_priority_reason: string | null
          secondary_type: string | null
          sentiment_by_speaker: Json | null
        ...
        Relationships: [
          {
            foreignKeyName: "teams_meeting_insights_meeting_id_fkey"
            columns: ["meeting_id"]
            isOneToOne: false
            referencedRelation: "teams_meetings"
            referencedColumns: ["id"]
      ...
      teams_meetings: {
        ...
        Relationships: [
          {
            foreignKeyName: "teams_meetings_business_unit_id_fkey"
            columns: ["business_unit_id"]
            isOneToOne: false
            referencedRelation: "teams_business_units"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "teams_meetings_teams_user_id_fkey"
            columns: ["teams_user_id"]
            isOneToOne: false
            referencedRelation: "teams_users"
            referencedColumns: ["id"]
          },
        ]
      }
      teams_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "teams_participants_meeting_id_fkey"
            columns: ["meeting_id"]
            isOneToOne: false
            referencedRelation: "teams_meetings"
            referencedColumns: ["id"]
      ...
      teams_transcriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "teams_transcriptions_meeting_id_fkey"
            columns: ["meeting_id"]
            isOneToOne: false
            referencedRelation: "teams_meetings"
            referencedColumns: ["id"]
      ...
      teams_users: {
        Row: {
          ...
          name: string
          pipedrive_person_id: number | null
          pipedrive_sync_enabled: boolean | null
          pipedrive_user_id: number | null
          updated_at: string | null
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "teams_users_business_unit_id_fkey"
            columns: ["business_unit_id"]
            isOneToOne: false
            referencedRelation: "teams_business_units"
            referencedColumns: ["id"]
    ...
    Functions: {
      calculate_client_points: {
        Args: { cliente_row: Database["public"]["Tables"]["clientes"]["Row"] }
        Returns: number
      }
      can_manage_opportunity_list: {
        Args: { _list_id: string; _user_id: string }
        Returns: boolean
      }
      can_view_opportunity_list: {
        Args: { _list_id: string; _user_id: string }
        Returns: boolean
      }
      can_view_responsavel: {
      ...
      count_opportunity_matches:
        ...
        | {
            Args: {
              p_has_responsavel: boolean
              p_list_id: string
              p_responsavel?: string
            }
            Returns: number
          }
      evaluate_opportunity_criteria: {
        Args: {
          cliente_row: Database["public"]["Tables"]["clientes"]["Row"]
          criteria_json: Json
        }
        Returns: boolean
      }
      ...
      get_opportunity_matches_paginated:
        | {
            ...
            Returns: {
              ...
              cliente: string
              consorcio_imovel: boolean
              consorcio_imovel_credito: number
              consorcio_outros: boolean
              consorcio_outros_credito: number
              consorcio_veiculo: boolean
              consorcio_veiculo_credito: number
              contato_feito: boolean
              cpf: string
              data_quality_score: number
              deal_status: string
              deal_status_updated_at: string
              email: string
              exported_at: string
              exported_to_crm: boolean
              hedge_agro_valor_anual: number
              hedge_assessoria: boolean
              hedge_assessoria_valor: number
              hedge_consultoria: boolean
              hedge_consultoria_valor: number
              investimentos_internacionais: boolean
              investimentos_internacionais_valor_usd: number
              investimentos_nacionais: boolean
              investimentos_nacionais_valor: number
              pipedrive_deal_id: number
              pipedrive_person_id: number
              planejamento_financeiro: boolean
              planejamento_financeiro_valor_anual: number
              ponto_venda: string
              previdencia: boolean
              previdencia_valor: number
              produtos_inbanq: boolean
              produtos_inbanq_valor: number
              profissao: string
              responsavel: string
              seguro_vida_internacional: boolean
              seguro_vida_internacional_valor: number
              seguro_vida_nacional: boolean
              seguro_vida_nacional_valor: number
              telefone: string
              venda_gerada: boolean
            }[]
          }
        | {
            Args: {
      ...
      renew_project: { Args: { project_id: string }; Returns: boolean }
    ...
    Enums: {
      app_role: "admin" | "responsavel" | "gestor"
    }
    CompositeTypes: {
      [_ in never]: never
    }
